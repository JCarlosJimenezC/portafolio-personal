...
- Vue.js. (s.f.). *Quick start — Composition API*. Recuperado el 11 de junio de 2026, de https://vuejs.org/guide/quick-start.html
- Vue.js. (s.f.). *Composition API FAQ*. Recuperado el 11 de junio de 2026, de https://vuejs.org/guide/extras/composition-api-faq.html
- Vue.js. (s.f.). *Reactivity fundamentals — ref() y onMounted()*. Recuperado el 12 de junio de 2026, de https://vuejs.org/guide/essentials/reactivity-fundamentals.html
- Vue.js. (s.f.). *Component Props — defineProps()*. Recuperado el 12 de junio de 2026, de https://vuejs.org/guide/components/props.html
- Vue.js. (s.f.). *List rendering — v-for*. Recuperado el 12 de junio de 2026, de https://vuejs.org/guide/essentials/list.html
- Vite. (s.f.). *Getting started*. Recuperado el 10 de junio de 2026, de https://vitejs.dev/guide/
- Vite. (s.f.). *Static asset handling*. Recuperado el 13 de junio de 2026, de https://vitejs.dev/guide/assets.html
- MDN Web Docs. (s.f.). *Fetch API*. Recuperado el 11 de junio de 2026, de https://developer.mozilla.org/es/docs/Web/API/Fetch_API
- MDN Web Docs. (s.f.). *CSS animation*. Recuperado el 12 de junio de 2026, de https://developer.mozilla.org/es/docs/Web/CSS/animation
- MDN Web Docs. (s.f.). *Intersection Observer API*. Recuperado el 12 de junio de 2026, de https://developer.mozilla.org/es/docs/Web/API/Intersection_Observer_API
- MDN Web Docs. (s.f.). *HTMLMediaElement — audio y video*. Recuperado el 13 de junio de 2026, de https://developer.mozilla.org/es/docs/Web/API/HTMLMediaElement
